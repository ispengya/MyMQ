...
public class Configuration {
    ...
    public Configuration registerConfig(Object configObject) {
        try {
            ...
            try {
                ...
                Properties registerProps = AllUtil.object2Properties(configObject);
        ...
        try {
            ...
            try {
                ...
                for (Object configObject : configObjectList) {
                    ...
                    AllUtil.properties2Object(properties, configObject);
                }
    ...
    public void persist() {
        try {
            ...
            try {
                ...
                AllUtil.string2File(allConfigs, getStorePath());
            } catch (IOException e) {
    ...
    public String getDataVersionJson() {
        try {
            return MQSerializer.toJson(this.dataVersion, false);
        } catch (Exception e) {
            log.error("getDataVersionJson error");
        }
        return null;
    }
    ...
    private String getAllConfigsInternal() {
        ...
        for (Object configObject : this.configObjectList) {
            Properties properties = AllUtil.object2Properties(configObject);
            if (properties != null) {
        ...
        {
            stringBuilder.append(AllUtil.properties2String(this.allConfigs));
        }
